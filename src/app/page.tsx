...
import Imagen1 from "../../public/imagen-1.jpg";
          ...
          <main>
              ...
              <section className={styles["container-box"]}>
                <div className={styles.box}>
                  ...
                  <p>
                    ...
                    pavimentadas de alta calidad. Conectarse con la ciudad y
                    otros destinos será rápido y cómodo, facilitando su día a
                    día y ofreciendo un transporte eficiente para usted y su
                    familia.
                  </p>
                </div>
                ...
                <div className={styles.box}>
                  ...
                  <p>
                    ...
                    cerca de su hogar. Desde vistas panorámicas hasta
                    actividades acuáticas, nuestro entorno fluvial ofrece una
                    conexión única con la naturaleza. Disfrute de paseos
                    relajantes, pesca o simplemente sumérjase en la tranquilidad
                    que proporciona la proximidad a un río.
                  </p>
                </div>
                ...
                <div className={styles.box}>
                  ...
                  <p>
                    ...
                    espacios ofrecen diversión acuática, áreas de recreación y
                    un ambiente relajado. Con un parque de agua cerca, siempre
                    tendrá la opción de disfrutar de momentos emocionantes y
                    refrescantes sin tener que alejarse demasiado de casa.
                  </p>
                </div>
            ...
            <section className={styles["container-map"]}>
              ...
              <div>
                ...
                <p>
                  Sumérgete en la serenidad de nuestro enclave, donde cada lote
                  es más que un simple espacio, es un oasis natural. Nuestra
                  ...
                  mientras disfrutas de un entorno que te invita a desconectar
                  del bullicio urbano y conectarte con la tranquilidad de la
            ...
            <section className={styles["container-video"]}>
              <div>
                ...
                <p>
                  ...
                  capturado desde la perspectiva aérea de un dron. Experimenta
                  la transición gradual desde la vida vibrante del pueblo hasta
                  la serena belleza de nuestros exclusivos lotes. Descubre la
                  armonía entre la comodidad urbana y la privacidad natural
                  mientras exploras cada detalle del camino que te llevará a un
                  nuevo capítulo de tu vida. ¡Bienvenido a tu futuro hogar,
                  donde la conexión con la naturaleza se encuentra con la
